      ...
      <div className="container mx-auto px-6 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="glitter-container magic-glow animate-float-card bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 hover:bg-white/10 transition-all duration-500 hover:scale-105 hover:border-green-400/30" style={{animationDelay: '0.5s'}}>
            ...
            <div className="glitter-container magic-glow animate-float-card bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 hover:bg-white/10 transition-all duration-500 hover:scale-105 hover:border-green-400/30" style={{animationDelay: '1s'}}>
              <span className="text-5xl text-green-400 mb-6 block">🖥️</span>
            ...
            <div className="glitter-container magic-glow animate-float-card bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 hover:bg-white/10 transition-all duration-500 hover:scale-105 hover:border-green-400/30" style={{animationDelay: '1.5s'}}>
              <span className="text-5xl text-green-400 mb-6 block">✅</span>
